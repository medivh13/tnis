        ...
        <div class="form-group">
          <div class="option-card">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{$product->name}}" aria-describedby="name-error">
              <em id="name-error" class="error invalid-feedback">Please enter a service name</em>
            </div>
            <div class="form-group">
              <label class="col-form-label" for="harga">Harga
              </label>
              <input type="text" class="form-control" id="harga" name="harga" placeholder="1000" value="{{$product->harga}}"aria-describedby="harga-error">
