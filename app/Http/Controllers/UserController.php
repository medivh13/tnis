    ...
    if($request->ajax()){
      ...
      $index = User::select([
        ...
        ->addColumn('action', function($index){
          $tag = "<center><a class='btn btn-primary btn-sm ubah' idt='".$index->id."')><i class='fa fa-pencil'></i> Ubah</a> ";
          $tag .= "<a class='btn btn-danger btn-sm hapus' idt='".$index->id."')><i class='fa fa-trash'></i> Hapus</a></center>";
          return $tag;
        })
        ->make(true);
      }
